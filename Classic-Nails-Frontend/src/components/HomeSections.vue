<template>
    ...
    <section class="u-clearfix u-palette-1-light-2 u-section-2" id="carousel_ce4b">
    ...
    <section class="u-clearfix u-section-4" id="sec-deba">
                            ...
                            <div class="u-layout-col">
                                ...
                                <div class="u-align-left u-container-style u-layout-cell u-left-cell u-size-30 u-layout-cell-2">
                                    <div class="u-container-layout u-valign-bottom u-container-layout-2">
                                        ...
                                        <p class="u-text u-text-3"> Indulge in the ultimate pampering experience with our waxing treatments at Classic Nails. Our skilled estheticians provide gentle and effective facial waxing services to help you achieve smooth, silky skin with minimal discomfort.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="u-clearfix u-sheet u-sheet-1">
            ...
            <div class="u-container-style u-group u-group-1">
                <div class="u-container-layout u-container-layout-1">
                    ...
                    <p class="u-text u-text-3"> Escape the stresses of everyday life with our luxurious stone massage treatments at Classic Nails. Our skilled massage therapists use heated stones to soothe tired muscles and promote relaxation, leaving you feeling rejuvenated and refreshed. With a focus on holistic wellness and personalized care, our stone massages are designed to melt away tension and restore balance to both body and mind.</p>
                </div>
            </div>
                                ...
                                <div class="u-align-left u-container-style u-layout-cell u-left-cell u-size-30 u-layout-cell-2">
                                    <div class="u-container-layout u-container-layout-2">
                                        ...
                                        <div class="u-social-icons u-spacing-20 u-social-icons-1"> <a class="u-social-url" target="_blank" href="https://www.instagram.com/_classic.nails/"><span class="u-icon u-icon-circle u-social-icon u-social-instagram u-icon-1"> <svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112.2 112.2">
                                                    ...
                                                    </svg> </span> </a> <a class="u-social-url" target="_blank" data-type="Yelp" title="Yelp" href="https://www.yelp.com/biz/classic-nails-houston-2?utm_campaign=www_business_share_popup&utm_med"><span class="u-icon u-social-icon u-social-yelp u-icon-2"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
                                                        <use xlink:href="#svg-5200"></use>
                                                    </svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-5200">
                                                        <circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
                                                        <path fill="#FFFFFF" d="M48.2,67c1.6-0.7,4.4-1.8,4.4-4.7c0-2.9-2.7-4-4.4-4.7c-0.6-0.3-1.4-0.6-2.4-1c-2.6-1-6-2.3-9.3-3.9
	c-3.2-1.5-5.4-1-6.6-0.2c-1.6,1-2.5,2.8-2.5,4.9v9.7c0,2.1,0.9,4,2.5,4.9c0.7,0.4,1.6,0.7,2.8,0.7c1.1,0,2.3-0.3,3.8-1
	c3.2-1.5,6.7-2.9,9.3-3.9C46.8,67.6,47.6,67.3,48.2,67z"></path>
                                                        <path fill="#FFFFFF" d="M59.9,76.1c-0.1-1-0.1-1.9-0.2-2.5c-0.2-1.7-0.4-4.6-3.3-5.5h0c-2.9-0.9-4.8,1.3-6,2.6
	...
	c1.3,0,2.5-0.4,3.5-1.1c1.1-0.9,2.3-2.7,1.8-6.1C60.4,82.3,60.1,78.7,59.9,76.1z"></path>
                                                        <path fill="#FFFFFF" d="M82,68.1c-3.5-0.6-7.2-1.5-9.9-2.1c-1-0.2-1.9-0.5-2.5-0.6c-1.7-0.4-4.6-1-6.4,1.3h0
	c-1.8,2.4-0.3,4.8,0.7,6.3c0.3,0.6,0.8,1.3,1.4,2.1c1.5,2.2,3.5,5.3,5.1,8.4c1.7,3.1,3.8,3.8,5.2,3.9c0.1,0,0.2,0,0.3,0
	c1.8,0,3.5-0.9,4.7-2.6l5.9-7.8c1.3-1.7,1.7-3.7,1-5.4C87,70.4,85.6,68.7,82,68.1z"></path>
                                                        <path fill="#FFFFFF" d="M63.2,61.9c1,1.3,2.4,1.7,3.7,1.7c1,0,2-0.2,2.7-0.4c0.7-0.1,1.5-0.4,2.5-0.6c2.7-0.6,6.3-1.5,9.9-2.1
	...
	c-0.6,0.9-1,1.6-1.4,2.1C63,57,61.4,59.5,63.2,61.9L63.2,61.9z"></path>
                                                        <path fill="#FFFFFF" d="M50,55c0.9,1.4,2.5,2.3,4.3,2.3c0.5,0,1-0.1,1.5-0.2c2.2-0.7,3.6-2.7,3.5-4.9l-1.7-29.1
	c-0.1-1.4-0.8-2.7-2-3.6c-1.2-0.8-2.7-1.2-4.1-0.9l-15.1,3.2c-1.6,0.3-2.9,1.4-3.6,2.9c-0.6,1.5-0.5,3.1,0.4,4.4L50,55z"></path>
                                                    </svg></span> </a> </div>
                                    </div>
                                </div>
                            </div>
